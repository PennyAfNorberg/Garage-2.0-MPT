...
namespace Garage_2._0_MPT.Migrations
{
    ...
    [Migration("20190128151203_AddWhereOnParkedVehicle")]
    partial class AddWhereOnParkedVehicle
    {
            ...
            modelBuilder.Entity("Garage_2._0_MPT.Models.ParkedVehicle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            NumberOfWheels = 4,
                            ParkInDate = new DateTime(2019, 1, 27, 14, 8, 58, 466, DateTimeKind.Local).AddTicks(8241),
                            RegNr = "Rymdopera",
                        ...
                        new
                        {
                            Id = 2,
                            NumberOfWheels = 4,
                            ParkInDate = new DateTime(2019, 1, 26, 14, 8, 58, 466, DateTimeKind.Local).AddTicks(9154),
                            RegNr = "abc 123",
                            VehicleBrand = "Volvo",
                            VehicleColor = "Red",
                            VehicleModel = "okänd",
                        ...
                        new
                        {
                            Id = 3,
                            NumberOfWheels = 4,
                            ParkInDate = new DateTime(2019, 1, 24, 14, 8, 58, 466, DateTimeKind.Local).AddTicks(9168),
                            ParkOutDate = new DateTime(2019, 1, 26, 13, 11, 17, 466, DateTimeKind.Local).AddTicks(9171),
                            RegNr = "acc 123",
                            VehicleBrand = "Saab",
                            VehicleColor = "Blue",
                            VehicleModel = "okänd",
